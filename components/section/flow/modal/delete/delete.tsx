...
export default function DeleteConfirmationModal({
  ...
  const titleText = `${title} ${entityText}`
                ...
                <p>
                  {
                    selectedCount === 1
                      ?
                    `Are you sure you want to ${actionText} the selected ${entityName}?`
                      :
                    `Are you sure you want to ${actionText} the ${selectedCount} selected ${entityName}s?`
                  }
                </p>
